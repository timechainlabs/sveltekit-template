<script lang="ts">
	...
	const copyToClipboard = (pm: keyof typeof packageManagers) => {
		...
		const text = `${packageManagers[pm]} degit timechainlabs/sveltekit-template <project-name>`;
...
<svelte:head>
	<title>Welcome to Timechain Summer of Code</title>
	<meta
		name="description"
...
<main class="layout h-screen w-full bg-black py-12 md:py-24 lg:py-32 xl:py-48">
			...
			<div class="flex flex-col justify-center space-y-4 text-center">
				...
				>
					...
					>
						...
						<span>
							pnpx degit timechainlabs/sveltekit-template {'<project-name>'}
						</span>
	...
	>
		<div class="mx-auto flex">
			<a
				href="https://github.com/timechainlabs"
				target="_blank"
			...
			<a
				href="https://x.com/timechainlabs"
				target="_blank"
				rel="noopener noreferrer"
				class="rounded-md border border-transparent p-2 hover:border-zinc-700 hover:bg-white/10"
			>
